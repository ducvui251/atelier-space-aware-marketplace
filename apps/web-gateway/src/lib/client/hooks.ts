...
export function useAuth() {
  const { currentUser, currentArtist, login, logout, updateProfile, refreshUser, ready } = useAppState();
  return { currentUser, currentArtist, login, logout, updateProfile, refreshUser, ready };
}
