...
export interface AppContextValue {
  ...
  logout(): Promise<void>;
  updateProfile(input: { fullName: string; phone?: string; bio?: string; portfolioUrl?: string; imageUrl?: string; originPostalCode?: string }): Promise<ActionResult>;
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateProfile = React.useCallback(
    async (input: { fullName: string; phone?: string; bio?: string; portfolioUrl?: string; imageUrl?: string; originPostalCode?: string }): Promise<ActionResult> => {
      try {
