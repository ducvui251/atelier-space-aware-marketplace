...
export const metadata: Metadata = {
  ...
  description: "Technical spike for the walkable 3D exhibition renderer.",
};
...
export default function ExhibitionDemoPage() {
  return (
    <PageContainer className="py-10">
      <div>
        <p className="eyebrow">Technical spike</p>
        <h1 className="mt-2 font-display text-h1 text-foreground">3D Exhibition Renderer</h1>
        <p className="mt-3 max-w-2xl text-body text-muted-foreground">
          Internal-only preview of the shared spatial engine: a canvas, camera, lighting, floor,
          and walls. No exhibition data yet.
        </p>
      </div>
      <div className="mt-6">
