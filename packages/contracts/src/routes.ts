...
export const ROUTES: RouteDefinition[] = [
  ...
  { method: "GET", path: "/v1/room-preview/exhibitions", service: "room-preview", summary: "List exhibitions, optionally filtered by creatorId or status", auth: "internal", successStatus: 200, errorStatuses: [401] },
