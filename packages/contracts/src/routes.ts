...
import {
  ...
  ArtistProfileUpdateRequestSchema,
...
export const ROUTES: RouteDefinition[] = [
  ...
  { method: "PATCH", path: "/v1/artist-artwork/artists/{id}", service: "artist-artwork", summary: "Self-service update of the caller's own artist profile (name, bio, portfolio, avatar)", auth: "internal", requestSchema: ArtistProfileUpdateRequestSchema, requestLocation: "body", successStatus: 200, errorStatuses: [400, 401, 404] },
  ...
  { method: "POST", path: "/v1/commerce/checkout/cancel", service: "commerce", summary: "Release the reservation and cancel pending orders for a checkout session the buyer exited (idempotent)", auth: "internal", requestSchema: CheckoutCancelRequestSchema, requestLocation: "body", successStatus: 200, errorStatuses: [400, 401] },
  { method: "POST", path: "/v1/commerce/shipping/quote", service: "commerce", summary: "Preview the shipping fee checkout will charge for a set of artworks (§ shipping Phase 2)", auth: "internal", requestSchema: ShippingQuoteRequestSchema, requestLocation: "body", successStatus: 200, errorStatuses: [400, 401, 404] },
  ...
  { method: "GET", path: "/v1/commerce/orders/{id}/resume-checkout", service: "commerce", summary: "Resume an open Stripe checkout for the buyer's order", auth: "internal", successStatus: 200, errorStatuses: [400, 401, 404, 409] },
  ...
  { method: "GET", path: "/v1/room-preview/exhibitions", service: "room-preview", summary: "List exhibitions, optionally filtered by creatorId, status, or slug", auth: "internal", successStatus: 200, errorStatuses: [401] },
  { method: "POST", path: "/v1/room-preview/exhibitions", service: "room-preview", summary: "Create a draft exhibition owned by an artist or admin", auth: "internal", requestSchema: CreateExhibitionRequestSchema, requestLocation: "body", successStatus: 201, errorStatuses: [400, 401, 409] },
  { method: "GET", path: "/v1/room-preview/exhibitions/{id}", service: "room-preview", summary: "Get one exhibition by id", auth: "internal", successStatus: 200, errorStatuses: [401, 404] },
  { method: "PATCH", path: "/v1/room-preview/exhibitions/{id}", service: "room-preview", summary: "Update an exhibition (owner artist, or any admin)", auth: "internal", requestSchema: UpdateExhibitionRequestSchema, requestLocation: "body", successStatus: 200, errorStatuses: [400, 401, 403, 404, 409] },
  { method: "DELETE", path: "/v1/room-preview/exhibitions/{id}", service: "room-preview", summary: "Delete an exhibition (owner artist, or any admin)", auth: "internal", successStatus: 200, errorStatuses: [400, 401, 403, 404] },
  { method: "GET", path: "/v1/room-preview/exhibitions/{id}/placements", service: "room-preview", summary: "List an exhibition's artwork placements", auth: "internal", successStatus: 200, errorStatuses: [401, 404] },
  { method: "POST", path: "/v1/room-preview/exhibitions/{id}/placements", service: "room-preview", summary: "Add an artwork placement (artist may only use their own artworks)", auth: "internal", requestSchema: CreateExhibitionPlacementRequestSchema, requestLocation: "body", successStatus: 201, errorStatuses: [400, 401, 403, 404] },
  { method: "PATCH", path: "/v1/room-preview/exhibitions/{id}/placements/{placementId}", service: "room-preview", summary: "Update a placement's transform", auth: "internal", requestSchema: UpdateExhibitionPlacementRequestSchema, requestLocation: "body", successStatus: 200, errorStatuses: [400, 401, 403, 404] },
  { method: "DELETE", path: "/v1/room-preview/exhibitions/{id}/placements/{placementId}", service: "room-preview", summary: "Remove a placement", auth: "internal", successStatus: 200, errorStatuses: [400, 401, 403, 404] },
