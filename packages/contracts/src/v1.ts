...
export const AdminArtworksQuerySchema = z.object({
...
export const AdminArtistsQuerySchema = z.object({
  status: z.enum(["pending", "verified", "rejected"]).optional(),
});
...
export type AdminArtworksQuery = z.infer<typeof AdminArtworksQuerySchema>;
export type AdminArtistsQuery = z.infer<typeof AdminArtistsQuerySchema>;
